...
/**
 * Entity class for system_views.local_read_latency virtual tables.
 * 
...
public final class LocalReadLatency extends Latency {
    
    public LocalReadLatency(String keyspace_name, String table_name, long count, double max_ms, double p50th_ms, double p99th_ms, double per_second) {
