...
/**
 * Entity class for system_views.coordinator_write_latency virtual tables.
 * 
...
public final class CoordinatorWriteLatency extends Latency {
    
    public CoordinatorWriteLatency(String keyspace_name, String table_name, long count, double max_ms, double p50th_ms, double p99th_ms, double per_second) {
