...
/**
 * Entity class for system_views.local_write_latency virtual tables.
 * <pre>
...
public final class LocalWriteLatency extends Latency {
     ...
     */
    public LocalWriteLatency(String keyspace_name, String table_name, long count, double max_ms, double p50th_ms, double p99th_ms, double per_second) {
